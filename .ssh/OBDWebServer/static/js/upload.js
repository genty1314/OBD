...
//                  $placeHolder.addClass( 'element-invisible' );
                ...
                case 'confirm':
                    ...
                    break;
                case 'finish'://全部图片上传成功后
                    stats = uploader.getStats();
                    if ( stats.successNum ) {
                        $("#showfolder").append(
                            "<tr>"+
                                "<td>"+
                                    //在webuploader.js中的第4984行被赋值
                                    uploader.options.formData.folder+
                                "</td>"+
                                "<td></td>"+
                                "<td></td>"+
                            "</tr>"
...
//          }
        ...
        uploader.on( 'uploadSuccess', function( file, response ) {
            ...
            // $("#show").append("<li style='width:220px;height:210px'>"+
            //                       "<img id='"+response.url+"' src = '../"+response.url+"'>"+
            //                       "<select>"+
        ...
        $upload.on('click', function() {
            ...
            //uploader.options.formData.folder = $folder.val();  
            if ( state === 'ready' ) {
                uploader.upload();
